<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="./index.php?page=home">RITCO Bus Booking</a></h1>
        ...
        <nav class="nav-menu d-none d-lg-block" id='top-nav'>
            <ul>
                ...
                <li class="drop-down nav-bus nav-location"><a href="#">Manage</a>
                    <ul>
                        <li><a href="./index.php?page=bus">Bus List</a></li>
                        <li><a href="./index.php?page=departure">Departures List</a></li>
                        <li><a href="./index.php?page=depart_period">Depart Period List</a></li>
                        <li><a href="./index.php?page=contacts">Contacts List</a></li>
                        <li><a href="./index.php?page=location">Location List</a></li>
                        <li><a href="./index.php?page=driver">Drivers List</a></li>
                    </ul>
                </li>
