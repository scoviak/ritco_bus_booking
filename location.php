             ...
             <div class="col-lg-12">
                 ...
                 <div class="row">
                     <div class="card col-md-12">
                         ...
                         <div class="card-body">
                             <table data-page-length='5' class="table table-striped table-bordered" id="location-field">
                                 <thead>
                                     <tr>
                    ...
                    if (Object.keys(resp).length > 0) {
                        ...
                        Object.keys(resp).map(k => {
                            ...
                            if ('<?php echo isset($_SESSION['login_id']) ? 1 : 0 ?>' == 1) {
                                tr.append(
                                    '<td><center><button class="btn btn-sm btn-primary edit_location mr-2" data-id="' +
                                    resp[k].id +
                                    '">Edit</button><button class="btn btn-sm btn-danger remove_location" data-id="' +
